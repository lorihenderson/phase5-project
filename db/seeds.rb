...
f2 = Post.create(user_id: 40, category_id: 34, fact: "John Legend has 10 Grammys.")
f3 = Post.create(user_id: 39, category_id: 38, fact: "Suriname is the smallest sovereign state in South America.")
f4 = Post.create(user_id: 37, category_id: 35, fact: "Katniss Everdeen comes from the Twelfth District in Panem.")
f5 = Post.create(user_id: 37, category_id: 39, fact: "Rhyme and Reason are the adoptive daughters of the King of Wisdom in The Phantom Tollbooth.")
f6 = Post.create(user_id: 37, category_id: 31, fact: "The Code of Hammurabi is the earliest known system of laws.")
f7 = Post.create(user_id: 37, category_id: 31, fact: "Australia was settled by Britain as a prison colony in 1788.")
f8 = Post.create(user_id: 37, category_id: 37, fact: "The thunderbird is a legendary creature  from Native American tradition.")
f9 = Post.create(user_id: 37, category_id: 40, fact: "Soft-serve ice cream involves increasing the amount of air.")
f10 = Post.create(user_id: 37, category_id: 32, fact: "Alexander Fleming discovered penicilin.")
f11 = Post.create(user_id: 37, category_id: 33, fact: "Tiger Woods was 21 when he won the Masters.")
